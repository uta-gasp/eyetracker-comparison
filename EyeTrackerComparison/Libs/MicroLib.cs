...
namespace MicroLib
{
    ...
    {
        public delegate void MicroTimerTickEventHandler(
                             object sender,
                             MicroTimerEventArgs timerEventArgs);
        public event MicroTimerTickEventHandler Tick;
        ...
        {
            IntervalMcs = timerIntervalInMicroseconds;
        }
        ...
        public long Interval
        {
            get
            {
                return System.Threading.Interlocked.Read(
                    ref _timerIntervalInMicroSec) / 1000;
            }
            set
            {
                System.Threading.Interlocked.Exchange(
                    ref _timerIntervalInMicroSec, 1000 * value);
            }
        }

        public long IntervalMcs
        {
            get
            {
                return System.Threading.Interlocked.Read(
                               ...
                               ref bool stopTimer)
        {
            ...
            while (!stopTimer)
            {
                ...
                MicroTimerEventArgs tickEventArgs =
