...
namespace TheCodeKing.ActiveButtons.Controls
{
    ...
    public interface IActiveMenu
    {
        ...
        /// <summary>
        /// 	Gets or sets the menu alighnment in the window title bar
        /// </summary>
        /// <value>The alighnment.</value>
        HorizontalAlignment Alighment { get; set; }

        /// <summary>
        /// 	Gets or sets the menu visibility state
        /// </summary>
