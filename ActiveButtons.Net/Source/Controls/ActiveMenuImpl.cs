...
namespace TheCodeKing.ActiveButtons.Controls
{
    ...
    internal class ActiveMenuImpl : Form, IActiveMenu
    {
        ...
        public HorizontalAlignment Alighment
        {
            get { return alignment; }
            set { alignment = value; OnPosition(); }
        }
            ...
            if (!IsDisposed)
            {
                ...
                switch (alignment)
                {
                    case HorizontalAlignment.Left:
                        Left = parentForm.Left + theme.FrameBorder.Width + theme.SystemButtonSize.Width;
                        break;
                    case HorizontalAlignment.Center:
                        Left = parentForm.Left + theme.FrameBorder.Width + (parentForm.Width - left - theme.SystemButtonSize.Width - containerMaxWidth) / 2;
                        break;
                    case HorizontalAlignment.Right:
                        Left = parentForm.Left + theme.FrameBorder.Width + parentForm.Width - containerMaxWidth - left;
                        break;
                }
